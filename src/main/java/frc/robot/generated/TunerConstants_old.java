...
public class TunerConstants_old {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(50).withKI(0).withKD(0.10)
    ...
    private static final Current kSlipCurrent = Amps.of(240.0); //acceleration
    ...
    // front of robot was rotated 90 degress from original programming
    // so the fron left module is now the back left module
    // and the front right module is front left module
    // the cand ids and encoder offsets have been shifted to the correct locations in positions/names to match
    // but the can ofssets may need to be rotaed 90 degrees to match the new positions

    // Front Left moved to back left
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.269775390625).plus(Rotations.of(Math.PI / 2)); // 90 degrees rotation
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.0869140625).plus(Rotations.of(Math.PI / 2));
    ...
    // private static final Angle kBackLeftEncoderOffset = Rotations.of(0.404541015625);
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.015380859375).plus(Rotations.of(Math.PI / 2));
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.404541015625).plus(Rotations.of(Math.PI / 2));

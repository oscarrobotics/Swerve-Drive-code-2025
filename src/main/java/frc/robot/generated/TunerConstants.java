...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs() //voltage based gains
        .withKP(50).withKI(0).withKD(0.10)
        .withKS(0.1).withKV(1.5).withKA(0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);

    // private static final Slot0Configs steerGains = new Slot0Configs()// torqueCurrentFOC  based gains
    //     .withKP(50).withKI(0).withKD(0.10)
    //     .withKS(0.1).withKV(0).withKA(0.1)
    //     .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    ...
    // Front Left<-now wrong is back left
